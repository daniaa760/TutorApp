...
public class SearchStudentsActivity extends AppCompatActivity
{
    ...
    myadaptertutor adapter;

    @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_main_tutor, menu);
        return true;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new myadaptertutor(option);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if(item.getItemId() == R.id.search_tutors){
            Toast.makeText(SearchStudentsActivity.this, "Error", Toast.LENGTH_LONG).show();
        }
        else if(item.getItemId() == R.id.user_profile){
            Intent intent = new Intent(SearchStudentsActivity.this, ProfileActivity.class);
            ...
            Intent intent = new Intent (SearchStudentsActivity.this, ChatsActivity.class);
            startActivity(intent);
        }
        return true;
    }
